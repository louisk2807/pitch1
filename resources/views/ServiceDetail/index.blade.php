    ...
    <div class="row">
                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{route('Service.create')}}" title="Thêm"><i class="fas fa-plus"></i>
                                Thêm Dịch Vụ</a>
                        </div>
                        <div class="col-sm-2">
        ...
        @foreach($servicedetails as $servicedetail)
            <tr>
                ...
                <td>
                    {{number_format ($servicedetail->totalPrice) }}
                </td>
                ...
                <td width="80">
                    ...
                    <a href="{{ route('Service.edit', $servicedetail->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>

                    <form method="post" action="{{route('Service.destroy', $servicedetail->id )}}">
                        @method('DELETE')
                        @csrf
