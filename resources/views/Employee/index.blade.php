                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route ('Employees.create') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới nhân viên</a>
                        </div>
                        <div class="col-sm-2">
                        ...
                        @foreach ($Employee as $Employees)
                            <tr>
                                ...
                                <td width="80">
                                    ...
                                    <a href="{{ route('Employees.edit', $Employees->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>
