...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="{{ route ('Employees.index') }}"><i class='app-menu__icon bx bx-id-card'></i>
...
<main class="app-content" >
    ...
    <div class="tile">
        ...
        <div class="tile-body">
            ...
            <form class="row"  method="post"  action="{{ route('Employees.store') }}" >
                @csrf
        ...
        <a class="btn btn-cancel" href="{{ route ('Employees.index') }}">Hủy bỏ</a>
    </div>
