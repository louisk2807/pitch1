...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Hóa đơn chi tiết</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route ('BookingDetail.store') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo sân mới</a>
                        </div>
                        <div class="col-sm-2">
...
@csrf
                            <tr>
                                ...
                                <td>
                                    {{$bookingschedule->payment}}
                                </td>

                                <td>
                                    @if($bookingschedule->status == 1)
                                        <span class="badge bg-primary">Chờ xác nhận</span>
                                    @elseif($bookingschedule->status == 2)
                                        <span class="badge bg-info">Đã duyệt San</span>

                                    @elseif($bookingschedule->status == 3)
                                        <span class="badge bg-danger">Đã hủy</span>
                                    @endif
                                </td>

                                <td>
                                    {{$bookingschedule->employee}}
                                </td>

                                <td>
                                    {{$bookingschedule->customerName}}
                                </td>

                                <td width="80">
                                <a href="{{route('BookingDetail.index')}}"><button class="btn btn-info">Detail</button></a>

                                <a href="{{route('ServiceDetail.index')}}"><button class="btn btn-info">Show</button></a>
