                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{route('PitchType.create')}}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới khach hang</a>
                        </div>
                        <div class="col-sm-2">
    ...
    @foreach($PitchType as $PitchTypes)
        <tr>
            ...
            <td width="80">
                ...
                <a href="{{ route('PitchType.edit', $PitchTypes->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>

                <form method="post" action="{{route('PitchType.destroy', $PitchTypes->id )}}">
                    @method('DELETE')
                    @csrf
