        ...
        @foreach($pitchs as $pitch)
            <div class="row">
                <div class="form-group col-md-6">
                    <label class="control-label">Ten San</label>
                    <input class="form-control" type="text" name="name" value="{{$pitch->name}}" >
                </div>


                    <div class="form-group col-md-6">
                        <label class="control-label">Price</label>
                        <input class="form-control" type="text" name="price" value="{{$pitch->price}}">
                    </div>


                        <div class="form-group col-md-6">
                            <label class="control-label">FreeTime</label>
                            <input class="form-control" type="text" name="freeTime" value="{{$pitch->freeTime}}">
                        </div>


                            <div class="form-group col-md-6">
                                <label class="control-label">PitchType</label>
                                <input class="form-control" type="text" name="PitchType" value="{{$pitch->PType_id}}">
                            </div>
                        </div>

                     <button class="btn btn-save" >Update</button>
                     <a class="btn btn-cancel" data-dismiss="modal" href="{{ route ('Pitch.index') }}">Hủy bỏ</a>
