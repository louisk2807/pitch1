                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route ('Customer.create') }}" title="Thêm"><i class="fas fa-plus"></i>
                   ...
                   <td>
                     ...
                     {{$Customers->name}}
                           ...
                           <td>
                               {{ str_repeat("*", strlen($Customers->password)) }}
                           </td>
                      ...
                      <td width="80">
                          ...
                          <a href="{{ route('Customer.edit', $Customers->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>
