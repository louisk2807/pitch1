                    ...
                    <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                        ...
                        @foreach($Service as $Services)
                            <tr>
                                ...
                                <td>
                                    {{number_format( $Services->price )}}
                                </td>

                                <td width="80">

                                    <a href="{{ route('Service.edit', $Services->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>

                                    <form method="post" action="{{route('Service.destroy', $Services->id )}}">
                                        @method('DELETE')
                                        @csrf
